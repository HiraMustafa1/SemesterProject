...
public class DBAdapter extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        String queryFaculty="CREATE TABLE "+ FACULTY_INFO_TABLE +" (" +
                ...
                KEY_FACULTY_FIRST_NAME + " TEXT, " +
                KEY_FACULTY_LAST_NAME + " TEXT, " +
	...
	public void onCreate(SQLiteDatabase db) {
		String CREATE_User_Info_TABLE = "CREATE TABLE " + TABLE_INFO_USER + "("
				+ KEY_ID + " INTEGER PRIMARY KEY, " + KEY_FIRST_NAME + " TEXT, "+ KEY_LAST_NAME + " TEXT, " +KEY_MO_NO +" TEXT, "
	...
	void addUserInfo(UserInfo userInfo) {
		...
		values.put(KEY_FIRST_NAME, userInfo.getUser_FirstName()); //  Name
		values.put(KEY_LAST_NAME, userInfo.getUser_LastName()); //  Name
	...
	UserInfo getUserInfo(int id) {
		...
		Cursor cursor = db.query(TABLE_INFO_USER, new String[] { KEY_ID,
				KEY_FIRST_NAME, KEY_LAST_NAME,KEY_MO_NO,  KEY_EMAIL, KEY_USERNAME, KEY_PASSWORD }, KEY_ID + "=?",
	...
	public UserInfo validateUser(String username, String password)
	{
		...
		if(!cursor.moveToFirst())
		{
			Log.d("Rupali", "cursor is null.. returning NULL");
			return null;
		}
